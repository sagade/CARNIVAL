...
Beside the exported model descriptions and figures, users can also visualise the overall network results in an R-Shiny application with the function 'shinyCARNIVAL'. This function requires the shiny and visNetwork packages (available on CRAN). The results from the CARNIVAL examples 1 and 2 can for instance be visualed on R-Shiny using the following command.
